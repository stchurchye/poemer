...
export function isAssistantGuideKey(value: unknown): value is AssistantGuideKey {
  return (
    typeof value === 'string' &&
    (ASSISTANT_GUIDE_KEYS as readonly string[]).includes(value)
  );
}
...
export function assistantGuideRulesForDialect(dialect?: ReplyDialect | null): string {
...
export function assistantChatGuideRulesForDialect(dialect?: ReplyDialect | null): string {
