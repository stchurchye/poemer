...
export function getChatWorkingWindowTokens() {
    const raw = typeof process !== 'undefined' ? process.env.CHAT_WORKING_WINDOW_TOKENS : undefined;
...
export function getWritingWorkingWindowTokens() {
    const raw = typeof process !== 'undefined' ? process.env.WRITING_WORKING_WINDOW_TOKENS : undefined;
