...
要求：
- 摘要要精炼，总篇幅务必控制在约 ${SUMMARY_CHAR_BUDGET} 个汉字以内（越短越好，不要写满）
...
要求：
- 摘要要精炼，总篇幅务必控制在约 ${SUMMARY_CHAR_BUDGET} 字以内（越短越好，不要写满）
...
export function formatHistoryForCompact(messages) {
    return messages
        .map((m) => {
...
//# sourceMappingURL=contextCompact.js.map